...
const Characters = () => {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden mb-[10%]">
       ...
       <CustomeCursor isHovering3D={setCursorInModelArea}/>

        {/* Section Title */}
        <div className="relative z-10 pt-6 text-center">
            <h1 
                className="text-5xl font-bold tracking-widest mb:-mb-14 mb-8"
        ...
        <div className="relative z-10 flex md:flex-row flex-col items-center w-full h-full p-4">
            ...
            <div className="w-full md:w-2/4 flex flex-col md:ml-10">
                ...
                <div className="flex gap-3">
                    <button 
                        className="
                            px-4 py-1 bg-violet-900 text-white
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative bg-gray-900/70 backdrop-blur-sm
                                rounded-lg p-3 border flex lg:flex-row flex-col
                                justify-between px-12 items-center cursos-pointer
                                transition-all duration-300"
            ...
            >
                     ...
                     {selectedAvatar === "VIKI" ? (
                        ...
                        >
                            <Spline scene="https://prod.spline.design/ji6CDD8KFmWedmMU/scene.splinecode" />
                        </motion.div>
                     ) : (
                         <motion.div
                            key="EVA"
                            ...
                            transition={{duration: 0.5}}
                        >
                            <Spline scene="https://prod.spline.design/bKbRexQtLpjARANc/scene.splinecode" />
                        </motion.div>
                     )}
                     </AnimatePresence>
            </div>
