...
const Header = () => {
  ...
  return (
    <header className="py-1 px-7 flex justify-between items-center stick top-0 z-50 w-full border-b-[0.3px] border-[#babaff] bg-black">
        {/* LEFT SECTION */}
        <div className="flex lg:gap-14 gap-4 items-center">
            ...
            <div className="hidden md:flex gap-5 items-center">
                <button 
                    className="h-8 px-6 bg-gradient-to-r 
                               from-purple-500 to-indigo-600 
                               rounded-lg font-medium text-nowrap 
         ...
         <nav className="hidden md:flex lg:gap-8 gap-4">
            <a 
                href="#"
                className="
                relative py-1 text-lg hover:text-purple-300 transition-colors
                duration-300 after:content-[''] after:absolute after:w-0
                after:h-0.5 after:bg-purple-400 after:left-0 after:bottom-0
                after:transition-all hover:after:w-full text-nowrap"
            >
                <i className="bx bx-user-circle"/> Avatar
            </a>
             <a 
                href="#"
                className="
